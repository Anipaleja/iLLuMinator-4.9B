...
class iLLuMinator4_9B(nn.Module):
    ...
    def __init__(self, 
                 ...
                 d_model: int = 4096,          # Model dimension (optimized for 4.9B target)
                 n_layers: int = 32,           # Number of transformer layers
                 n_heads: int = 32,            # Number of attention heads
                 n_kv_heads: int = 8,          # Number of key-value heads (for GQA)
                 d_ff: int = 14336,            # Feed-forward dimension (3.5x d_model for SwiGLU)
...
if __name__ == "__main__":
    ...
    print("   • RMSNorm for better stability")
    print("   • Larger vocabulary and context length")
    print("   • Tied embeddings for parameter efficiency")
